...
describe('Wallet', () => {
    ...
    it('displays the balance fron props', () => {
        expect(wallet.find('.balance').text()).toEqual('Wallet balance: 20')
    })

    it('Creates an input to deposit or withdraw fron the balance', () => {
    ...
    describe('when the user types into the wallet input', () => {
        ...
        describe('and the user wants to make a withdrawal', () => {
            ...
            it('dispatches the `withdrawal()` it receives props with local balance  ', () => {
